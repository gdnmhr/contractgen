...
public enum RISCV_OBSERVATION_TYPE {
    ...
    /**
     * @return the value contract template
     */
    ...
    /**
     * @return the instruction contract template
     */
    public static Set<RISCV_OBSERVATION_TYPE> getInstruction() {
        return Set.of(
                INSTRUCTION,
                PC
        );
